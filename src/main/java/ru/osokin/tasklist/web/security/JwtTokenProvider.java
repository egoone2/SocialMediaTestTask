...
import ru.osokin.tasklist.service.props.JwtProperties;
...
/**
 * JWTProvider - класс, предоставляющий access, refresh токен.
 * так же проводит валидацию токена по времени
 *
 */
...
public class JwtTokenProvider {
    ...
    public String createAccessToken(Long userId, String username, Set<Role> roles) {
        ...
        Date now = new Date();
        Date validity = new Date(now.getTime() + jwtProperties.getAccess());    // дата, когда токен перестанет действовать
